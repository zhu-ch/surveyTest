let app = new Vue({
    ...
    data: {
        ...
        urls: {
            // api for entity
            insertEntity: serverUrl + '/api/sys/config/insertOrUpdateConfig',
            deleteEntityListByIds: serverUrl + '/api/sys/config/deleteConfigByIds',
            updateEntity: serverUrl + '/api/sys/config/insertOrUpdateConfig',
            selectEntityListByPage: serverUrl + '/api/sys/config/selectConfigListByPage',

            selectConfigTypeAllList: serverUrl + '/api/sys/config/getConfigTypeList'
        },
    ...
    methods: {
        ...
        resetForm: function (ref) {
            this.dialog.insertEntity.formData.configKey = ''
            this.dialog.insertEntity.formData.configValue = ''
            this.dialog.insertEntity.formData.sort = 0
            this.dialog.insertEntity.formData.remark = ''
        },
    },
    created: function () {
        let app = this;
        ...
        ajaxGet(this.urls.selectConfigTypeAllList, null, function (d) {
            console.log(d)
            app.options.configType = d.data;
